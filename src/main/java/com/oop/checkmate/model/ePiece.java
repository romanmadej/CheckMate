...
public enum ePiece {
	...
	public static ePiece get_ePiece(char typeChar) {
		switch (typeChar) {
		case 'p':
			return B_PAWN;
		case 'n':
	...
	public static ePiece get_ePiece(Constants.Color color, Constants.PieceType pieceType) {
		switch (pieceType) {
		case KNIGHT:
	...
	ePiece(Constants.Color color, Constants.PieceType pieceType) {
		this.color = color;
